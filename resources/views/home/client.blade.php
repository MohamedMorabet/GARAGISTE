  ...
  <footer class="footer">
    <div class="containerfooter">
      <div class="footer-section company-info">
        <h3>About Us</h3>
        <p>Providing high-quality mechanical services and solutions. Our team is dedicated to excellence and customer
          satisfaction.</p>
      </div>
      ...
      <div class="footer-section contact-info">
        ...
        <p>Address: Barbourine Hay DarMoursia Rue n° 3, Tetouan, Morocco</p>
      </div>
    </div>
    <div class="footer-bottom">
      <p>&copy; 2024 El-Morabet Mechanics Site. All rights reserved.</p>
    </div>
  </footer>
