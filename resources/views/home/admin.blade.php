...
<style>
  ...
  .contai .glass {
    ...
    padding-left: 10px;
    background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS77VQZmP67szhUtE563APyzBpRp6nTs_NtXw&s');
    color: white;
    font-weight: bold;
    filter: blur(0.5px); 
  ...
  .contai .cn {
    background-image: url('https://img.pikbest.com/back_our/20210127/bg/9fcc984cc88ee.png!f305cw');
...
<h1 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">@lang('garage_overview')</h1>
<div class="contai">
  <div data-text="@lang('report')" style="--r:-15;" class="glass">
    @lang('pending_repairs') &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp; {{ $number_of_repairs_pending }} <br>
    @lang('repairs_in_progress') &nbsp;:&nbsp;&nbsp; {{ $number_of_repairs_in_progress }} <br>
    @lang('completed_repairs') &nbsp;&nbsp;:&nbsp;&nbsp; {{ $number_of_repairs_completed }} <br>
    @lang('total_repairs') &nbsp;&nbsp;:&nbsp;&nbsp; {{ $number_of_repairs }}
  </div>
  <div data-text="@lang('repairs_waiting')" style="--r:5;" class="glass">
    @lang('repairs_waiting_message', ['count' => $repairs_without_mechanical])
  </div>

  <div data-text="@lang('this_month')" style="--r:25;" class="glass">
    @lang('total_revenue_this_month') <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$total}} $
  </div>
  <div data-text="@lang('stock')" style="--r:35;" class="glass">
    @if ($spare_parts == 0)
      @lang('stock_levels_satisfactory')
    @else
      @lang('spare_parts_restock', ['count' => $spare_parts])
    @endif
  </div>
</div><br>

<h1 style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">@lang('clients')</h1>
<div class="contai">
  <div data-text="@lang('new_clients')" style="--r:-15;" class="glass cn">
    @lang('last_clients_sign_in'):
    @foreach ($last_clients as $client)
        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$client->name}}
    @endforeach
</div>
<div data-text="@lang('clients_feedback')" style="--r:5;" class="glass cn">
    @lang('no_new_feedbacks')
</div>
<div data-text="@lang('today_clients')" style="--r:25;" class="glass cn">
    @lang('clients_sign_in_today'): {{$clients}}
</div>
  ...
  <div class="content">
    <div class="benefits">
      <div class="basic-marquee basic-marquee-1">
            ...
            <svg viewBox="0 0 132.004 132" xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <defs>
                ...
                <radialGradient fy="578.088" fx="158.429"
                  gradientTransform="matrix(0 -1.98198 1.8439 0 -1031.402 454.004)" gradientUnits="userSpaceOnUse"
                  xlink:href="#a" r="65" cy="578.088" cx="158.429" id="c"></radialGradient>
                <radialGradient fy="473.455" fx="147.694"
                  gradientTransform="matrix(.17394 .86872 -3.5818 .71718 1648.348 -458.493)"
                  gradientUnits="userSpaceOnUse" xlink:href="#b" r="65" cy="473.455" cx="147.694" id="d">
                </radialGradient>
              </defs>
        ...
        <a class="social-media-link" href="#">
          <button class="button">
            <svg viewBox="0 0 512 512" data-name="Layer 1" id="Layer_1" xmlns:xlink="http://www.w3.org/1999/xlink"
              xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse"
                  gradientTransform="matrix(0.19, 0, 0, -0.19, 0.81, 98.89)" y2="-2164.82" x2="1337.28" y1="518.24"
                  x1="1337.28" id="linear-gradient">
          ...
          <button class="button">
            <svg viewBox="0 0 122.88 122.39" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                class="cls-1"></path>
              <path d="M37.07,32.34A14.41,14.41,0,1,1,22.66,46.75,14.41,14.41,0,0,1,37.07,32.34Z" class="cls-10"></path>
              <path d="M85.74,32.34A14.41,14.41,0,1,1,71.33,46.75,14.41,14.41,0,0,1,85.74,32.34Z" class="cls-10"></path>
            </svg>
          </button>
        </a>
        <a class="social-media-link" href="#">
          <button class="button">
            <svg viewBox="0 0 512 512" clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality"
              ...
              xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient y2="507.468" x2="251.069" y1=".003" x1="251.069" gradientUnits="userSpaceOnUse"
                  id="prefix__a">
          ...
          <button class="button">
            <svg viewBox="0 0 122.88 122.88" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M25.2,0H97.68a25.27,25.27,0,0,1,25.2,25.2V97.68a25.27,25.27,0,0,1-25.2,25.2H25.2A25.27,25.27,0,0,1,0,97.68V25.2A25.27,25.27,0,0,1,25.2,0Z"
                class="cls-17"></path>
              <path d="M30.38,30.35V42.27A50.29,50.29,0,0,1,80.57,92.52h12A62.23,62.23,0,0,0,30.38,30.36Z"
                class="cls-18"></path>
              <path d="M30.36,51.48V63.39A29.12,29.12,0,0,1,59.43,92.53h12a41.09,41.09,0,0,0-41-41.05Z" class="cls-18">
              </path>
              <path d="M38.63,75.94a8.26,8.26,0,1,0,8.29,8.26,8.29,8.29,0,0,0-8.29-8.26Z" class="cls-18"></path>
            </svg>
          </button>
        </a>
        <a class="social-media-link" href="#">
